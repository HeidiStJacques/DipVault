...
export default function LookBookScreen() {
  ...
  const handleToggleFavorite = async (id: string) => {
    // Update immediately so the heart feels responsive
    setLooks((prev) =>
      prev.map((look) =>
        look.id === id
          ? {
          ...
          ListEmptyComponent={
            <View style={styles.empty}>
              ...
              <Text style={styles.emptySubtitle}>
                Tap + to document your first nail
                look.
              </Text>
    ...
    <View style={cardStyles.container}>
      ...
      >
        {currentPhoto ? (
          ...
          <View
            style={cardStyles.photoPlaceholder}
          >
            <Ionicons
              name="image-outline"
              size={48}
      ...
      {look.products.length > 0 && (
        <View style={cardStyles.productsRow}>
          <Text
            style={cardStyles.productsLabel}
          >
            Products:{' '}
          </Text>

          <Text
            style={cardStyles.productsText}
            numberOfLines={2}
          >
            {look.products
              .map(
