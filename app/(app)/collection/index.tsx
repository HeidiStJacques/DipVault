...
export default function CollectionScreen() {
  ...
  const [sort, setSort] =
    useState<SortOption>('date_newest');
  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      // authFetch handles the expired login.
      // AuthContext will switch to logged out and
      // the protected layout will redirect to /login.
      if (res.status === 401) {
        return;
      }
